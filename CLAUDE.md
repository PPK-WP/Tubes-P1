...
| `docs/srs/SRS_Anggota*.md` | Kebutuhan formal (FR, acceptance criteria, NFR) per role — di branch `srs/*` | Masing-masing, disetujui PM |
...
Lihat `Relationship.md` §17 dan `docs/srs/SRS_Anggota1_PM.md` §7. Yang paling mendesak: OQ-01 (reservasi multi-slot), OQ-08 (identitas & username GitHub), OQ-13 (nilai enum), OQ-17 (starter kit), OQ-23 (repo publik/privat).
